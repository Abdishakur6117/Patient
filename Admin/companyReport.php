        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <!-- Supplier Table -->
                    <table id="company_table" class="display nowrap" style="width:100%; display:none;">
                    <thead>
                        <tr>
                        <td>ID</td>
                        <td>Employee Name</td>
...
//         const searchTerm = $('#company_name').val();
...
//                 type: 'POST',
//                 data: function (d) {
//                 d.searchTerm = $('#company_name').val(); // Always use updated value
//                 }
//             },
//             columns: [
//                 { data: 'company_id' },
...
//                     return `<button class="btn btn-primary" onclick="report(${row.company_id})">View</button>`;
//                 }
//                 }
//             ],
//             paging: true,
...
//     function report(employerId) {
//     window.open('company_print.php?employer_id=' + employerId, '_blank');
//     }
  ...
  if (!companyTable) {
    companyTable = $('#company_table').DataTable({
      ...
      ajax: {
        ...
        type: 'POST',
        data: function (d) {
          d.searchTerm = $('#company_name').val();
        }
      },
      columns: [
        { data: 'company_id' },
        { data: 'employee_name' },  // magaca shaqaalaha (employer)
        { data: 'company_name' },
        { data: 'description' },
        { data: 'location' },
        {
...
function report(id) {
  window.open('company_print.php?id=' + id, '_blank');
}
