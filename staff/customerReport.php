        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <!-- Supplier Table -->
                    <table id="customer_table" class="display nowrap" style="width:100%; display:none;">
                    <thead>
                        <tr>
                        <td>ID</td>
                        <td>Customer Name</td>
...
<script>
  ...
  function searchCustomer() {
    const searchTerm = $('#customer_name').val();
    ...
    if (!customerTable) {
        ...
        ajax: {
            ...
            type: 'POST',
            data: function (d) {
            d.searchTerm = $('#customer_name').val(); // Always use updated value
            }
        },
        columns: [
            { data: 'sale_id' },
            ...
            render: function (data, type, row) {
                return `<button class="btn btn-primary" onclick="report(${row.sale_id})">View</button>`;
            }
            }
        ],
        paging: true,
  ...
  function report(id) {
    window.open('customer_print.php?id=' + id, '_blank');
  }
</script>
